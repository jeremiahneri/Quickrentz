...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $update = "UPDATE `vehicle` SET `Image4`='$image4' WHERE `VehicleID` = '$id'";
...
<body>
    <div class="main-container d-flex h-100">
        ...
        <div class="content">
            ...
            <h1 class="col-md-12 px-3">Update Image 4</h1>
            <hr>
            ...
            <div class="container p-3">
                <div class="text-center p-5" style="border: 2px solid #000;border-radius:8px;">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <img class="mb-3" src="img/vehicleuploads/<?php echo $results['Image4'] ?>"
                            style="border:1px solid #000;" alt="" height="180">
                        <br>
                        <label class="px-4 fs-4">New Image</label>
                        <input class="py-3" type="file" name="image4">
                        <div class="col-12">
